...
void TypeSection::parse_section() {
    ...
    for (int type_idx = 0; type_idx < count_; type_idx++) {
        entries_.insert(type_idx, FuncType());
    }



    // TODO: parse the entries into FuncType objects
...
//                imports_[import_index++] = ImportEntry{module_name, import_name, (ExternalType) type, typeidx};
//                break;
//            }
//
//            default:
