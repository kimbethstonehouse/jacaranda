...
#ifndef GOOGLE_PROTOBUF_INCLUDED_jacaranda_2eproto
#define GOOGLE_PROTOBUF_INCLUDED_jacaranda_2eproto
...
#include <google/protobuf/port_def.inc>
#define PROTOBUF_INTERNAL_EXPORT_jacaranda_2eproto
...
struct TableStruct_jacaranda_2eproto {
...
extern const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_jacaranda_2eproto;
class CodeRequest;
...
class IndicesRequest final :
 ...
 private:
  ...
  friend struct ::TableStruct_jacaranda_2eproto;
};
// -------------------------------------------------------------------
...
inline uint32_t WasmFunction::_internal_body_length() const {
  return body_length_;
}
inline uint32_t WasmFunction::body_length() const {
  // @@protoc_insertion_point(field_get:WasmFunction.body_length)
  return _internal_body_length();
}
inline void WasmFunction::_internal_set_body_length(uint32_t value) {
  
  body_length_ = value;
}
inline void WasmFunction::set_body_length(uint32_t value) {
...
#include <google/protobuf/port_undef.inc>
#endif  // GOOGLE_PROTOBUF_INCLUDED_GOOGLE_PROTOBUF_INCLUDED_jacaranda_2eproto
